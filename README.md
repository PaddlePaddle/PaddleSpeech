...
- Many thanks to [vpegasus](https://github.com/vpegasus)/[VTuberTalk](https://github.com/vpegasus/xuesebot) for developing a rasa chatbot,which is able to speak and listen thanks to PaddleSpeech.
