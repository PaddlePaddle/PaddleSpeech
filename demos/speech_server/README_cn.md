...
``` bash
paddlespeech_client vector --task spk  --server_ip 127.0.0.1 --port 8590 --input 85236145389.wav
```
...
``` bash
  ...
  [2022-05-08 00:18:44,250] [    INFO] - endpoint: http://127.0.0.1:8590/paddlespeech/vector
...
``` bash
paddlespeech_client vector --task score  --server_ip 127.0.0.1 --port 8590 --enroll 85236145389.wav --test 123456789.wav
```
...
``` bash
  ...
  [2022-05-09 10:28:40,556] [    INFO] - endpoint: http://127.0.0.1:8590/paddlespeech/vector/score
