...
def parse_args():
    ...
    parser.add_argument("--hist_percent",
                        type=float,
                        default=0.9999,
                        help="The percentile of algo:hist.")
    parser.add_argument("--is_full_quantize",
                        type=str2bool,
                        default=False,
    ...
    parser.add_argument("--ce_test",
                        type=str2bool,
                        default=False,
                        help="Whether to CE test.")
    parser.add_argument(
        "--onnx_format",
        type=str2bool,
        default=False,
    ...
    parser.add_argument("--quantizable_op_type",
                        type=list,
                        nargs='+',
                        default=[
                            "conv2d_transpose", "conv2d", "depthwise_conv2d",
...
def quantize(args):
    ...
    dataloader = get_dev_dataloader(dev_metadata=dev_metadata,
                                    am=args.model_name,
    ...
    quant_post_static(executor=exe,
                      ...
                      quantize_model_path=args.inference_dir + "/" +
                      args.model_name + "_quant",
